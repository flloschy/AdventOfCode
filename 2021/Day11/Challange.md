...
seem to not like the Christmas lights on your submarine, so you turn them off for now.

There are 100 octopuses arranged neatly in a 10 by 10 grid. Each octopus slowly gains **energy** over \
time and **flashes** brightly for a moment when its energy is full. Although your lights are off, maybe you \
could navigate through the cave without disturbing the octopuses if you could predict when the flashes \
...
of all adjacent octopuses by `1`, including octopuses that are diagonally adjacent. If this causes an \
octopus to have an energy level greater than `9`, it **also flashes**. This process continues as long as new \
...
> - [My](https://github.com/flloschy) answer was 1613. ([Here](https://github.com/flloschy/AdventOfCode/blob/main/2021/Day11/a.py))
___
### --- Part Two ---
...
> - [My](https://github.com/flloschy) answer was 510. ([Here](https://github.com/flloschy/AdventOfCode/blob/main/2021/Day11/b.py))
___
